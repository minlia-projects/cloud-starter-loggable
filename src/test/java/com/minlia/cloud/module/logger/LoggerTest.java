...
public class LoggerTest {
  ...
  public void logTraceError() {
    ...
    Pattern pattern = Pattern
        .compile("TRACE logger name - trace message.*java.lang.Exception: error message",
  ...
  public void logDebugError() {
    ...
    Pattern pattern = Pattern
        .compile("DEBUG logger name - debug message.*java.lang.Exception: error message",
            Pattern.DOTALL | Pattern.MULTILINE);
    assertTrue(pattern.matcher(capture.toString()).find());
  }
  ...
  public void logInfoError() {
    ...
    Pattern pattern = Pattern
        .compile("INFO logger name - info message.*java.lang.Exception: error message",
            Pattern.DOTALL | Pattern.MULTILINE);
    assertTrue(pattern.matcher(capture.toString()).find());
  }
  ...
  public void logWarningError() {
    ...
    Pattern pattern = Pattern
        .compile("WARN logger name - warn message.*java.lang.Exception: error message",
            Pattern.DOTALL | Pattern.MULTILINE);
    assertTrue(pattern.matcher(capture.toString()).find());
  }
  ...
  public void logErrorError() {
    ...
    Pattern pattern = Pattern
        .compile("ERROR logger name - error message.*java.lang.Exception: error message",
            Pattern.DOTALL | Pattern.MULTILINE);
    assertTrue(pattern.matcher(capture.toString()).find());
  }
  ...
  public void logFatalError() {
    ...
    Pattern pattern = Pattern
        .compile("ERROR logger name - fatal message.*java.lang.Exception: error message",
            Pattern.DOTALL | Pattern.MULTILINE);
    assertTrue(pattern.matcher(capture.toString()).find());
  }
